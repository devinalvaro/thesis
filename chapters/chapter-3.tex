...
Gambar~\ref{fig:MemoryScheme} mengilustrasikan penggunaan memori (dan \en{memory swapping}) di TensorFlow dalam konteks \en{backpropagation}. Ketika memori hampir penuh saat \en{feed forward}, \en{tensor} terbaru di-\en{swap out} ke memori CPU. Kemudian, ketika diperlukan saat \en{backpropagation}, \en{tensor} bersangkutan di-\en{swap in} kembali ke memori GPU.

\begin{figure}[htp]
    \centering
    \includegraphics[width=1\linewidth]{figures/swapping.png}
    \caption{Penggunaan memori di TensorFlow; \textbf{kiri}: \en{tensor} terbaru di-\en{swap out} saat \en{feed forward}; \textbf{kanan}: \en{tensor} di-\en{swap in} saat \en{backpropagation}.}
    \label{fig:MemoryScheme}
\end{figure}
...
Gambar~\ref{fig:TensorStackOptimized} mengilustrasikan \code{Stack} dan \code{Tensor} pada program teroptimisasi, sebagai perbandingan dengan Gambar~\ref{fig:TensorStack}. Pada gambar sebelah kanan telah dilakukan \en{swapping} terhadap \en{oldest tensor}, sehingga \en{tensor} tersebut menunjuk ke memori CPU.

\begin{figure}[htp]
    \centering
    \includegraphics[width=1\linewidth]{figures/tensor-stack-optimized.png}
    \caption{Ilustrasi \code{Stack} dan \en{Tensor} teroptimisasi; \textbf{kiri}: sebelum dilakukan \en{swapping}; \textbf{kanan}: setelah \en{oldest tensor} di-\en{swap}.}
