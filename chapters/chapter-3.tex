...
Selain \code{Stack}, terdapat kelas \code{StackPushOp} dan \code{StackPopOp}, dua \en{op} yang bertanggung jawab meletakkan dan mengambil \en{tensor} seperti telah yang disebutkan.
