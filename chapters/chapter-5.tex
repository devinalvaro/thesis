...
\begin{enumerate}
    ...
    \item Menurut pengujian, optimisasi \en{memory swapping} tersebut dapat mengurangi durasi \en{training} dari 2.5\% hingga 3.2\%, apabila jumlah \en{timestep} dari model mencukupi.
\end{enumerate}
