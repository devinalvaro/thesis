...
TensorFlow, sebuah \en{framework} pembelajaran mesin, memiliki fitur \en{memory swapping}. Namun, terdapat potensi bahwa \en{memory swapping} di TensorFlow masih dapat di-\en{improve}. Secara singkat, \en{improvement} terletak pada pemilihan data mana yang di-\en{swap}, sehingga pada akhirnya mengurangi penambahan durasi pelatihan akibat \en{memory swapping}.

Melihat potensi \en{improvement} tersebut, fokus tugas akhir ini adalah meneliti dan meng-\en{improve} \en{memory swapping} di TensorFlow sehingga lebih baik dari yang sudah ada, dilihat dari durasi pelatihan.

\section{Rumusan Masalah}

Sebelumnya telah disebutkan bahwa salah satu metode \en{improvement} memori adalah \en{memory swapping}, yaitu mengurangi beban memori GPU dengan memindahkan isi memori ke CPU secara sementara, seperti yang tersedia pada TensorFlow. Berdasarkan hasil studi literatur dan analisis mekanisme \en{memory swapping} di TensorFlow, terdapat potensi bahwa mekanisme tersebut masih kurang optimal. Secara singkat, solusi yang diajukan untuk meng-\en{improve} \en{memory swapping} di TensorFlow adalah dengan memprioritaskan \en{swapping} pada \en{tensor} yang interval hingga digunakannya kembali terlama, sehingga meningkatkan \en{overlapping} antara komputasi dengan \en{memory swapping}.

Rumusan masalah pada tugas akhir ini adalah sebagai berikut.

\begin{enumerate}
    \item Bagaimana meng-\en{improve} \en{memory swapping} di TensorFlow agar mengurangi durasi pelatihan?
    \item Bagaimana kinerja \en{memory swapping} di TensorFlow yang telah di-\en{improve} dibandingkan dengan yang sebelumnya?
\end{enumerate}

\section{Tujuan}

Tujuan tugas akhir ini adalah meng-\en{improve} \en{memory swapping} di TensorFlow dengan metode yang dijelaskan pada \nameref{SolutionDesign}. Harapan tercapainya tujuan tersebut adalah mengurangi durasi pelatihan dibandingkan dengan menggunakan \en{memory swapping} bawaan TensorFlow.
