...
Tujuan tugas akhir ini adalah mengoptimisasi \en{memory swapping} pada TensorFlow dengan metode yang akan dijelaskan pada \nameref{solutiondesign}. Untuk eksperimen, digunakan model berbasis RNN seperti LSTM yang dipilih karena topologi \en{neural network}-nya yang dinamis, sehingga penggunaan memorinya juga dinamis (penjelasan lebih lanjut terdapat pada \nameref{problemanalysis}).
...
Tabel~\ref{table:Calendar} berikut menunjukkan jadwal rencana kegiatan pelaksanaan tugas akhir ini untuk setiap minggunya.
...
\multirow{25}{*}{2019} & \multirow{4}{*}{Januari}          & 1               &                                                             \\ \cline{3-4}
                       ...
                       &                                   & 2               &                                                             \\ \cline{3-3}
                       &                                   & 3               &                                                             \\ \cline{3-3}
                       &                                   & 4               & \multirow{2}{*}{Seminar TA II}                              \\ \cline{2-3}
