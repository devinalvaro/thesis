...
Seperti \en{neural network} biasa, pelatihan RNN pada umumnya menggunakan \en{gradient descent} dengan \en{backpropagation} seperti pada Bagian \ref{backpropagation}~\nameref{backpropagation}. Hanya saja, untuk setiap \en{layer} terdapat 3 jenis bobot dengan perhitungan gradien yang berbeda. Selain itu, terdapat faktor \en{timestep} yang harus diperhitungkan. Pada Gambar~\ref{fig:RecurrentNeuralNetwork}, terdapat bobot $u$, $v$, dan $w$. Berikut ditunjukkan perhitungan gradien untuk ketiga bobot tersebut.
