...
\begin{equation}
    \delta_{j} = \sum_{k} \frac{\partial{C}}{\partial{net_{k}}} \frac{\partial{net_{k}}}{\partial{o_{j}}} \frac{\partial{o_{j}}}{\partial{net_{j}}} = \sum_{k} \delta_{k} \frac{\partial{net_{k}}}{\partial{o_{j}}} \frac{\partial{o_{j}}}{\partial{net_{j}}} = \sum_{k} \delta_{k} w_{kj} a'(net_{j})
    \label{eq:hidden}
\end{equation}
