...
Gambar~\ref{fig:CudaMemcpyAsync} berikut mengilustrasikan mekanisme tersebut.

\begin{figure}[htp]
    \centering
    \includegraphics[width=0.625\linewidth]{figures/cuda-memcpy-async.png}
    \caption{Mekanisme \en{asynchronous memory copy} antara \en{host} dan \en{device} \citep{wilt2013cuda}.}
    \label{fig:CudaMemcpyAsync}
\end{figure}
