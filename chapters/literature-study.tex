...
Berbagai penelitian menunjukkan bahwa pada model \en{deep learning}, menambah jumlah \en{neuron} dan \en{hidden layer} dapat meningkatkan performa model$^{[citation\ needed]}$. Tetapi, meningkatkan kompleksitas model seperti demikian juga memperbesar \en{training cost}, seperti waktu training dan memori yang dibutuhkan. Berikut akan dibahas beberapa penyebab meningkatnya kebutuhan memori pada model \en{deep learning} seiring meningkatnya kompleksitas model.
