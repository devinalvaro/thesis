...
Terdapat satu lagi hal yang perlu dibahas, yaitu heurustik pada \en{swapping in}. Seperti heuristik pada \en{swapping out}, \en{swapping in} dilakukan ketika memori GPU hampir penuh. Dipilih nilai yang \code{kOccupancy} yang sama yaitu 0.7, untuk menyamai nilai yang digunakan di \en{swapping out}, karena nilai heuristik tersebut sudah ada di versi bawaan TensorFlow. Selain itu, menurut pengamatan penulis, apabila nilai \code{kOccupancy} pada \en{swapping out} lebih rendah dari nilai \code{kOccupancy} pada \en{swapping out}, akibatnya \en{swapping in} menjadi kurang agresif dan mengurangi peningkatan kinerja. Sebaliknya, bila nilai \code{kOccupancy} pada \en{swapping in} lebih tinggi dari nilai \code{kOccupancy} pada \en{swapping out}, \en{swapping in} menjadi lebih agresif dan dapat mengakibatkan penuhnya memori (OOM).
