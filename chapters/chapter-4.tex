...
Tabel~\ref{table:Specification} berikut memaparkan spesifikasi lingkungan yang digunakan penulis dalam melakukan pengujian.
...
\endhead
%
\textit{Operating System}                & Ubuntu 18.04 64-bit                                                                                            \\ \hline
\textit{Processor}                       & Intel Xeon CPU @ 2.20GHz                                                                                       \\ \hline
\textit{Memory}                          & 12 GB                                                                                                          \\ \hline
\textit{GPU}                             & \begin{tabular}[c]{@{}l@{}}NVIDIA Tesla P4\\ \en{Memory}: 8 GB\\ \en{Driver}: 418.56\\ CUDA: 10.0\end{tabular} \\ \hline
...
\begin{longtable}{cll}
\hline
\multicolumn{1}{|c|}{\textbf{i}} & \multicolumn{1}{c|}{\textbf{Original}}  & \multicolumn{1}{c|}{\textbf{Optimized}} \\ \hline
\endfirsthead
%
\endhead
%
...
\multicolumn{1}{|c|}{10}         & \multicolumn{1}{l|}{}                   & \multicolumn{1}{l|}{1659.0270841121674} \\ \hline
...
\textbf{Mean}                    & 3416.72308                              & 3316.12052                              \\
