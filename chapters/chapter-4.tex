...
Pada bagian ini dijelaskan mengenai implementasi optimisasi \en{memory swapping} di TensorFlow menurut \nameref{SolutionDesign}. Implementasi yang dilakukan berupa modifikasi terhadap \en{kernel} TensorFlow, terutama di \en{file} \code{tensorflow/core/kernels/\\stack.cc}. Karena modifikasi dilakukan di level \en{kernel}, optimisasi ini transparan dari sudut pandang \en{end-user} TensorFlow.
...
Setiap pengujian dilakukan dengan beberapa kali melakukan \en{training} suatu model RNN menggunakan TensorFlow yang asli dan yang teroptimisasi, kemudian durasi \en{training} kedua perlakuan dibandingkan dan dihitung rataannya. Selain itu, dilakukan uji statistik lain seperti \en{t-test} untuk memastikan bahwa durasi \en{training} kedua perlakuan memang berbeda.
...
Bagian ini berisi hasil setiap kasus pengujian, diikuti dengan pembahasan hasil pengujian pada bagian selanjutnya. Pada setiap pengujian, ditampilkan durasi \en{training} (dalam satuan detik) kedua perlakuan (TensorFlow asli dan teroptimisasi) pada masing-masing 10 kali percobaan.

\subsubsection{Kasus A1}

Tabel~\ref{tbl:A1} menunjukkan hasil pengujian kasus A1. Dengan \en{t-test} didapat \en{p-value} 0.86, sehingga tidak dapat dikatakan bahwa versi teroptimisasi berbeda secara signifikan dengan versi asli.
...
Tabel~\ref{tbl:A2} menunjukkan hasil pengujian kasus A2. Meski versi teroptimisasi memiliki rataan sedikit lebih rendah, \en{p-value} dari \en{t-test} masih 0.14, sehingga sama seperti kasus sebelumnya, tidak dapat dikatakan bahwa versi teroptimisasi berbeda secara signifikan dengan versi asli.
...
Tabel~\ref{tbl:A3} menunjukkan hasil pengujian kasus A3. Meski versi teroptimisasi memiliki rataan sedikit lebih rendah, \en{p-value} dari \en{t-test} masih 0.14, sehingga sama seperti kasus sebelumnya, tidak dapat dikatakan bahwa versi teroptimisasi berbeda secara signifikan dengan versi asli.
...
Tabel~\ref{tbl:A4} menunjukkan hasil pengujian kasus A4. Tidak seperti kasus-kasus sebelumnya, mulai dari kasus ini \en{p-value} dari \en{t-test} sangat kecil yaitu 8.78e-10, sehingga versi teroptimisasi dapat dikatakan berbeda secara signifikan dengan versi asli. Selain itu, versi teroptimisasi berhasil mengurangi durasi \en{training} sebesar 2.6\%.
...
Tabel~\ref{tbl:A5} menunjukkan hasil pengujian kasus A5. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} lebih jauh dari sebelumnya, yaitu sebesar 2.98\%. Hal ini didukung dengan \en{p-value} dari \en{t-test} yang bernilai 3.73e-16.
...
Tabel~\ref{tbl:A6} menunjukkan hasil pengujian kasus A6. Pada kasus ini, pengurangan durasi \en{training} dari versi teroptimisasi mengalami penurunan menjadi 2.6\%. Selain itu, \en{p-value} dari \en{t-test} bernilai 8.65e-10.
...
Tabel~\ref{tbl:A7} menunjukkan hasil pengujian kasus A7. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 3.13\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 1.5e-10.
...
Tabel~\ref{tbl:A8} menunjukkan hasil pengujian kasus A8. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.63\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 2.98e-13.
...
Tabel~\ref{tbl:A9} menunjukkan hasil pengujian kasus A9. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.84\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 3.83e-17.
...
Tabel~\ref{tbl:B1} menunjukkan hasil pengujian kasus B1. Dengan \en{t-test} didapat \en{p-value} 0.26, sehingga tidak dapat dikatakan bahwa versi teroptimisasi berbeda secara signifikan dengan versi asli.
...
Tabel~\ref{tbl:B2} menunjukkan hasil pengujian kasus B2. Pada kasus ini, versi teroptimisasi hanya mengurangi durasi \en{training} sebesar 0.37\%. Meskipun begitu, menurut \en{t-test}, \en{p-value} bernilai 0.0009 sehingga dapat dikatakan kedua perlakuan berbeda secara signifikan.
...
Tabel~\ref{tbl:B3} menunjukkan hasil pengujian kasus B3. Pada kasus ini, versi teroptimisasi hanya mengurangi durasi \en{training} sebesar 0.7\%. Meskipun begitu, menurut \en{t-test}, \en{p-value} bernilai 0.0005 sehingga dapat dikatakan kedua perlakuan berbeda secara signifikan.
...
Tabel~\ref{tbl:B4} menunjukkan hasil pengujian kasus B4. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 3.02\%. Berdasarkan \en{t-test}, nilai \en{p-value} kasus ini adalah 7.73e-19.
...
Tabel~\ref{tbl:B5} menunjukkan hasil pengujian kasus B5. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.92\%. Berdasarkan \en{t-test}, nilai \en{p-value} kasus ini adalah 1.03e-21.
...
Tabel~\ref{tbl:B6} menunjukkan hasil pengujian kasus B6. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.87\%. Berdasarkan \en{t-test}, nilai \en{p-value} kasus ini adalah 7.24e-16.
...
Tabel~\ref{tbl:B7} menunjukkan hasil pengujian kasus B7. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.54\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 2.44e-9.
...
Tabel~\ref{tbl:B8} menunjukkan hasil pengujian kasus B8. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.71\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 2.8e-18.
...
Tabel~\ref{tbl:B9} menunjukkan hasil pengujian kasus B9. Pada kasus ini, versi teroptimisasi mengurangi durasi \en{training} sebesar 2.66\%. Menurut \en{t-test}, \en{p-value} kasus ini bernilai 4.73e-17.
...
Selanjutnya, pengujian dilakukan terhadap jumlah \en{epoch} yang berbeda-beda untuk mengamati apakah lama durasi \en{training} mempengaruhi selisihnya antara kedua perlakuan. Dari hasil pengujian yang didapat, antara \en{jumlah epoch} yang kecil dan besar, selisih dapat naik (A8 ke A9) maupun turun (A8 ke B6). Maka dari itu, tidak dapat disimpulkan bahwa \en{jumlah epoch} mempengaruhi selisih antara versi asli dan versi teroptimisasi.

Kemudian, antara kasus dengan prefiks "A" dan prefiks "B", hanya berbeda pada \en{dataset} yang digunakan, yaitu data kecil dan besar (disebut di Bagian~\ref{ExperimentMethod}). Dengan mengamati hasil pengujian, tidak terlihat pola yang menunjukkan bahwa jenis \en{dataset} mempengaruhi selisih durasi \en{training}. Artinya, versi teroptimisasi dapat bekerja untuk berbagai jenis \en{dataset}.

Secara keseluruhan, dari hasil pengujian dapat disimpulkan bahwa selisih durasi \en{training} antara versi asli dan versi teroptimisasi paling dipengaruhi oleh jumlah \en{timestep}, sedangkan jumlah \en{epoch} dan jenis \en{dataset} tidak terlalu membawa pengaruh. Di bawah jumlah \en{timestep} tertentu, durasi \en{training} versi teroptimisasi tidak jauh berbeda dengan versi asli, sedangkan di atas jumlah \en{timestep} tertentu, versi teroptimisasi secara konsisten mengurangi durasi \en{training} sebesar 2.5\% hingga 3.2\%.
